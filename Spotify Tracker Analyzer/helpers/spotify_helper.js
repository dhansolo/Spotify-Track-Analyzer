...
module.exports = {
    ...
    async get_song_recommendations(accessToken, tracks, danceability, energy, positivity) {
        console.log("Getting Recommendations");
        let url = config.url + `recommendations?seed_tracks=${tracks}&target_danceability=${danceability}&target_energy=${energy}&target_valence=${positivity}&target_popularity=1`
        let headers = {
